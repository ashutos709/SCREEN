...
let BRAND = {
    app: {
        language: 'en',
        name: 'SCREEN',
        title: 'SCREEN<br />Free browser based Real-time video calls.<br />Simple, Secure, Fast.',
        description:
    ...
    site: {
        title: 'SCREEN, Free Video Calls, Messaging and Screen Sharing',
    ...
    meta: {
        description:
            'SCREEN, Real-time Simple Secure Fast video calls, messaging and screen sharing capabilities in the browser.',
        keywords:
    ...
    about: {
        ...
        html: `
            ...
            <a
                ...
                href="mailto:miroslav.pejic.85@gmail.com?subject=SCREEN info">
                miroslav.pejic.85@gmail.com
            </a>
            <br /><br />
            <hr />
            <span>&copy; 2025 SCREEN, all rights reserved</span>
            <hr />
        `,
    },
    //...
